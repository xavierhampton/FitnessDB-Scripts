class initDatabase:
    ...
    def run(self):
       ...
       try:
              self.cursor.execute("DROP DATABASE FITNESS")
       except:
              print('No Database to Drop. Continuing\n')

       self.cursor.execute("CREATE DATABASE FITNESS")
       self.cursor.execute("USE FITNESS")

       #---------------------------------------------------
       #Creates Trainer Table
       self.cursor.execute("""CREATE TABLE TRAINER (
       ...
       #Creates Gym Table
       self.cursor.execute("""CREATE TABLE GYM (
                     Gym_ID              INT             NOT NULL,
                     Name                VARCHAR(15),
                     City                VARCHAR(15),
                     State               VARCHAR(2),
       ...
       self.cursor.execute("""CREATE TABLE EXERCISE (
       ...
       self.cursor.execute("""CREATE TABLE TRAINER_LANGUAGES (
                     Trainer_ID          INT             NOT NULL,
       ...
       self.cursor.execute("""INSERT INTO TRAINER 
       ...
       #Creates Gym Data
       self.cursor.execute("""INSERT INTO GYM 
       ...
       self.cursor.execute("""INSERT INTO APPOINTMENT 
       ...
       self.cursor.execute("""INSERT INTO EXERCISE (Client, Date, Name, Weight, Rep_Count) 
       ...
       self.cursor.execute("""INSERT INTO TRAINER_LANGUAGES
                     VALUES (111, 'English'),
                            (111, 'Spanish'),
                            (222, 'English'),
                            (333, 'English')
